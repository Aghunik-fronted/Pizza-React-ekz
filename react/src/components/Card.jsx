...
function Card({ name, price, img, onClickAdd }) {
  ...
  return (
    <div className='w-[280px] text-center mb-10'>
        ...
        <div className='flex items-center justify-between mt-5 px-2'>
            ...
            <button onClick={onClickAdd} className='flex items-center gap-2 border border-[#fe5f1e] px-4 py-2 rounded-full font-bold text-[#fe5f1e] cursor-pointer hover:bg-[#fe5f1e] hover:text-white transition-all group'>
